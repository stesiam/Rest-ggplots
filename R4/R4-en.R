...
freqs_mps_elected = parliament %>%
  ...
  select(FullNameEdit, n, Party, FullName) %>%
  dplyr::filter(n >=9) %>%
  arrange(-n)

title_text = glue("**Most elected MPs on Greek Parliament (1981 - 2019)**")
subtitle_text = glue("A list that shows the most elected members of parliament (elected 9 times or more)
                       The vast majority of them are members of <span style = 'color:#0492c2;'>New Democracy</span> 
                       (<span style = 'color:#0492c2;'>ND</span>) & 
                     <span style = 'color:#95bb72;'>Panhellenic Socialistic Movement</span> 
                     (<span style = 'color:#95bb72;'>PASOK</span>). The list includes
                     just 4 MPs from other parties, 2 from <span style = 'color:#FF6666;'>Communist Party
                     of Greece</span> (KKE) and 2 from <span style = 'color:#e27bb1;'>Coalition of the Radical Left</span> (SYRIZA)")
caption_text = glue("<b> Data: </b> Hellenic Parliament Website (hellenicparliament.gr)<br>
...
final_plot_light = final_plot + 
  geom_richtext(aes(y = 12.5, x = "Pavlidis A"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 9 times</span> <br> elected"),
                                              fill = NA, label.color = NA,
                                              label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 13, x = "Papariga A"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 10 times</span> <br> elected"),
                fill = NA, label.color = NA, 
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 13.5, x = "Nikolopoulos N"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 11 <br> times</span><br>elected"),
                fill = NA, label.color = NA,
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 14, x = "Meimarakis E"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 12</span>"),
                fill = NA, label.color = NA, hjust=0.5,
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 14.5, x = "Papandreou G"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 13</span>"),
                fill = NA, label.color = NA, hjust=0.5,
                label.padding = grid::unit(rep(0, 4), "pt")) +
...
final_plot_dark = final_plot +
  geom_richtext(aes(y = 12.5, x = "Pavlidis A"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 9 times</span> <br> elected"),
                fill = NA, label.color = NA, color = "gray90",
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 13, x = "Papariga A"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 10 times</span> <br> elected"),
                fill = NA, label.color = NA, color = "white",
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 13.5, x = "Nikolopoulos N"), 
                label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 11 <br> times</span><br>elected"),
                fill = NA, label.color = NA, color = "white",
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 14, x = "Meimarakis E"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 12</span>"),
                fill = NA, label.color = NA, hjust=0.5, color = "white",
                label.padding = grid::unit(rep(0, 4), "pt")) +
  geom_richtext(aes(y = 14.5, x = "Papandreou G"), label = glue("<span style='font-size: 20pt;'><span style='font-family:fs;'  >&#xf772;</span> 13</span>"),
                fill = NA, label.color = NA, hjust=0.5, color = "white",
                label.padding = grid::unit(rep(0, 4), "pt")) +
