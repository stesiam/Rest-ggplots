...
theme_light_custom <- function(base_size = 10, base_family = "rs") {
  theme_minimal(base_size = base_size, base_family = base_family) +
    theme(
      ...
      plot.caption = element_markdown(color = "#444444", hjust = 0.5, lineheight = 1.3),
...
theme_dark_custom <- function(base_size = 10, base_family = "rs") {
  theme_minimal(base_size = base_size, base_family = base_family) +
    theme(
      ...
      plot.caption = element_markdown(color = "gray70", hjust = 0.5, lineheight = 1.3),
      legend.position = "right",
      legend.text = element_text(color = "gray70", size = base_size-2,face =  "bold")
    )
}
...
title_text = glue("Αναλογία φοιτητών ανά βαθμίδα εκπαίδευσης")
subtitle_text = glue(" Οι **<span style = 'color:#a40000; font-weight: bold'>προπτυχιακοί</span>** φοιτητές
                     αποτελούν το 95% του συνολικού πληθυσμού φοιτητών του τμήματος. Οι **<span style = 'color:#c68958; font-weight: bold'>μεταπτυχιακοί</span>** 
                     αποτελούν περίπου το 5% και οι  **<span style = 'color:purple; font-weight: bold'>διδακτορικοί</span>** 
                     αποτελούν μόλις το 0.5%.")
caption_text = glue("<b> Δεδομένα: </b> Οδηγός σπουδών του τμήματος Στατιστικής και Ασφαλιστικής Επιστήμης <br><b>Γράφημα:</b> <span style='font-family:fb;'  >&#xf09b;</span> <b>stesiam</b>, 2024")
...
final_plot = B %>%
  ...
  scale_label_pictogram(
    ...
    labels = c(
      BSc_students = "Προπτυχιακοί",
      MSc_Students = "Μεταπτυχιακοί",
      PhD = "Διδακτορικοί"
    )
  ) +
  scale_color_manual(
...
ggsave(
  filename = "R3/R3-Students/r3-el-light.png",
...
ggsave(
  filename = "R3/R3-Students/r3-el-dark.png",
